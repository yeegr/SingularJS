...
export function validateUsername(username: string): boolean {
  return validateRange(username.length, CONST.INPUT_LIMITS.MIN_USERNAME_LENGTH, CONST.INPUT_LIMITS.MAX_USERNAME_LENGTH)
}
 ...
 * @returns {string} 
 */
export function getValueByInputName(name: string): string | null {
