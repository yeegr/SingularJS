...
export const USER = {
  GROUP_CREATOR_REQUIRED: 'GROUP_CREATOR_REQUIRED',
  GROUP_TITLE_REQUIRED: 'GROUP_TITLE_REQUIRED'
}

export const GROUP = {
  USER_NOT_FOUND: 'USER_NOT_FOUND',
  NOT_GROUP_MEMBER: 'NOT_GROUP_MEMBER',
  NOT_GROUP_MANAGER: 'NOT_GROUP_MANAGER',
  ALREADY_A_MEMBER: 'ALREADY_A_MEMBER',
  NOT_EMPTY: 'NOT_EMPTY',
  CANNOT_REMOVE_MANAGER: 'CANNOT_REMOVE_MANAGER'
}