...
![阿里云-注册](./img/aliyun/aliyun_signup.png "阿里云-注册")

*** 注意 *** 一个手机号码只能绑定最多两个阿里云账号！

###### 搜索域名

![阿里云-域名搜索](./img/aliyun/aliyun_domain_search.png "阿里云-域名搜索")
...
![阿里云-控制台](./img/aliyun/aliyun_control_panel.png "阿里云-控制台")

![阿里云-ECS实例](./img/aliyun/aliyun_ecs_instance.png "阿里云-ECS实例")
...
![项目列表](./img/teambition/teambition_mac_home.png "Teambition项目列表")

![项目首页](./img/teambition/teambition_mac_project.png "Teambition项目首页")
